...
const AddNewPopup = ({ toggleAddNaPopup }) => {
    const formRef = useRef(null);

    useClickOutside(formRef , () =>  toggleAddNaPopup() )
            ...
            >
                <div className='flex items-center justify-between pb-3 border-b'>
                    <div className='flex items-center gap-2 '>
                        ...
                        <h3 className='font-semibold'>Add NA</h3>
                    </div>
                    <div className='text-xl cursor-pointer' onClick={() => (
                        toggleAddNaPopup(false)
                    )} >
                ...
                <div className='mt-8'> 
                    <form className='flex flex-col gap-4'>
                        <div className='flex-1 flex flex-col gap-2'>
                            <label className='text-[15px]' htmlFor="pName" >Name</label>
                            <input 
                            id='pName'
                            type="text" 
                            placeholder='Enter new NA name'
                            className='textField'
                            />
                        </div>
                        <div className='mt-4'>
